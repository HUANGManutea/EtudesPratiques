...
\end{abstract}
	...
	\section{Cahier des charges}
		Afin de pouvoir livrer une application en adéquation avec l'idée que se fait notre "client", nous avons du suivre un cahier des charges.
		
		Tout d'abord, il faut que l'usage de l'application se fasse de manière intuitive et qu'un utilisateur novice puisse s'en servir sans explication. Le serveur qui va recevoir le nouvel objet est sous Unity, il faut donc que l'objet exporté puisse être compatible avec le système Unity. 	
