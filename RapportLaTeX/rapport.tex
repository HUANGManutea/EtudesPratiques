...
\end{abstract}
	...
	\section{Objectifs}
		...
		%Ne correspond pas car ce place trop sur le moment présent. On doit se placer comme si on étais au rendu.
			La sauvegarde s'est vite placée comme une fonctionnalité non prioritaire dans l'application. Nous l'avons mise en fin de file des tâches à réaliser. Comme ce n'était pas un point du cahier des charges, nous ne pouvons pas considérer nos objectifs comme ratés.
			À pat ce point précis, nous n'avons rien changé à notre vision de l'application élaborée pendant les premiers mois d'études.
	\section{Conclusion}
