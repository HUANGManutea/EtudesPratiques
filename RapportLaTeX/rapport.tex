...
\end{abstract}
	...
	\section{Cahier des charges}
		Notre client nous as imposé le cahier des charges qui suis:
	...
	%Rappel rapide des technologies utilisées
		...
		Une fois le dessin extrudé, pour le placer dans l'environnement 3D, l'utilisateur pourra à l'aide d'un menu (1) orienté et re-dimensionner la figure selon chacun de ses axes les un après les autres. Pour se retrouvé dans l'environnement, il aura une camera qui suis l'objet selon l'axe courant (2). Et une camera amovible et zoomable qui filmera l'ensemble de la scène déjà crée (3). Ici les cubes sont des objets crée précédemment qui sont passer en transparent pour facilité la lisibilité.
