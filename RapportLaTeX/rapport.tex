...
\end{abstract}
	...
	%changer le nom de cette partie.
		...
		\subsection{Dessin}
			...
			Dans l'application il y a deux parties dédiées au dessin 2D à main levée. Une, les outils, est en rapport avec les fonctions qui ont servies à crée l'IHM , tandis que la zone de dessin en est dissociée.
