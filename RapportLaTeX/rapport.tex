...
\end{abstract}
	...
	\section{Etape par étape}
		...
		\subsection{Export}
			...
			Dans notre cas, dès que la connexion est établie, le client envoie sous forme de flux les données de l'objet en 3D. Cette action correspond à la requête sur le schéma. Puis, en guise de traitement, le serveur affiche l'objet en 3D dans la scène.
	...
	\section{Conclusion}
		...
		Nous avons réalisé des tests avec des utilisateurs, ce qui assure un certain niveau d'ergonomie, en précisant juste où se trouve les outils et le menu extrudés, ils arrivent à créée des objets 3D.
