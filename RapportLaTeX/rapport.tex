...
\end{abstract}
	...
	\section{Conception}
		...
		\centerline{\includegraphics[scale=0.55]{images/Cmt_placer2.png}}
		...
		%Unity basé composant => pas d'héritage toussa toussa...
				\centerline{\includegraphics[scale=0.3]{images/archi.png}}
	...
	%changer le nom de cette partie.
		...
		\subsection{Export} %Manutea
			...
			\centerline{\includegraphics[scale=0.76]{images/tcp-socket.png}}
