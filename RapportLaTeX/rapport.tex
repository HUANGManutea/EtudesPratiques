...
\end{abstract}
	...
	\section{Objectifs}
		...
		Pour le dessin, nous nous sommes contenté de trois tailles pour l'outil de coloriage. On a remarqué que disposé d'un suivit parfait du tracé était compliqué, et nous avons opté pour un suivit plus approximatif.
