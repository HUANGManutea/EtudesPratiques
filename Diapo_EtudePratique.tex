...
\begin{document}
	...
	\section{Introduction}
		...
		\begin{frame}{The subject}
			...
			\underline{Final objective :} Occupy a room with simple objects made by an user
		\end{frame}
	...
	\end{frame}
		...
		\begin{frame}{A project made by Sony}
			...
			\begin{itemize}
				...
				\item Too simple : a single drawing
	...
	\section{The technology : the engine}
		...
		\subsection{Others API}
			...
			\begin{frame}{A recap}
				\begin{tabularx}{10cm}{|c|X|X|X|X|}
					\hline
					\textbf{Software} & \textbf{Easy to learn} & \textbf{Manage many objects} & \textbf{Price} & \textbf{Help for tablet}\\
					\hline
					\textit{Unreal Engine} & \color{green}{\checkmark} & \color{green}{\checkmark} & \color{orange}{$\sim$} & \color{red}{$\times$}\\
					\hline
					\textit{CryEngine} & \color{green}{\checkmark} & \color{green}{\checkmark} & \color{orange}{$\sim$} & \color{orange}{$\sim$}\\
					\hline
					\textit{OpenGl} & \color{red}{$\times$} & \color{orange}{$\sim$} & \color{green}{\checkmark} & \color{red}{$\times$}\\
					\hline
					\textit{Autodesk Maya} & \color{red}{$\times$} & \color{green}{\checkmark} & \color{red}{$\times$} & \color{orange}{$\sim$}\\
					\hline
					\textit{Unity} & \color{green}{\checkmark} & \color{green}{\checkmark} & \color{green}{\checkmark} & \color{green}{\checkmark} \\
					\hline
				\end{tabularx}
			\end{frame}
